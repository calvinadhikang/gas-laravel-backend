...
class InvoiceNonPPNExport implements FromView, WithStyles, WithColumnWidths
{
    protected $invoice;
    ...
    {
        return view('documents.invoice-nonppn', [
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $totalSectionEnd = $totalSectionStart;
        ...
        $sheet->getStyle('E' . $perhatianSectionStart . ':E' . $perhatianSectionEnd)->getBorders()->getAllBorders()->setBorderStyle(Border::BORDER_THIN);
        $sheet->getStyle('F' . $perhatianSectionStart . ':F' . $perhatianSectionEnd)->getBorders()->getAllBorders()->setBorderStyle(Border::BORDER_THIN);

        // bagian rekening
        $rekeningSectionStart = $perhatianSectionEnd + 2;
        ...
        $sheet->getStyle('B' . $rekeningSectionStart . ':B' . $rekeningSectionEnd)->getBorders()->getOutline()->setBorderStyle(Border::BORDER_THIN);
    }
